...
function BusAdmin() {
  ...
  const formatBusDetailsAsTable = () => {
    ...
    const busesData = [
      { busNo: '3', route: 'Kannur', starttime: '08:20', returntime: '16:45' },
      { busNo: '6', route: 'Chovva', starttime: '08:20', returntime: '16:45' },
      { busNo: 'Anvita', route: 'Thalassery', starttime: '08:20', returntime: '16:45' },
      { busNo: '2', route: 'Mattanur', starttime: '08:35', returntime: '16:54' },
      { busNo: 'Amritham', route: 'Thalassery', starttime: '08:40', returntime: '16:45' }
    ];
    ...
    // Add "Generated by Aidify" footer
    table += '\nGenerated by Aidify';
  
    return table;
  };
  
  console.log(formatBusDetailsAsTable());
